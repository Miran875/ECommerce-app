...
import com.imran.gshop.databinding.ActivityProductDetailBinding
import com.imran.gshop.roomdb.AppDatabase
import com.imran.gshop.roomdb.ProductDao
...
class ProductDetailActivity : AppCompatActivity() {
    ...
    private fun cartAction(proId: String, name: String?, productSp: String?, coverImg: String?) {
        ...
        if (productDao.isExist(proId) != null) {
            binding.textView6.text = "GO to cart"
        } else {
            binding.textView6.text = "Add to cart"
        }
